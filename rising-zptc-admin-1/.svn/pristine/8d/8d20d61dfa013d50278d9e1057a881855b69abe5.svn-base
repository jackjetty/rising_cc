 ...
 *         &lt;element name="sParmContent" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = { "sThirdID", "sParamTypeThirdID",
		"sParmContent" })
@XmlRootElement(name = "UploadParamCode")
public class UploadParamCode {

	protected String sThirdID;
	protected String sParamTypeThirdID;
	protected String sParmContent;
	...
	/**
	 * Gets the value of the sParmContent property.
	 * 
	 * @return possible object is {@link String }
	 * 
	 */
	public String getSParmContent() {
		return sParmContent;
	}

	/**
	 * Sets the value of the sParmContent property.
	 * 
	 * @param value
	 *            allowed object is {@link String }
	 * 
	 */
	public void setSParmContent(String value) {
		this.sParmContent = value;
	}
