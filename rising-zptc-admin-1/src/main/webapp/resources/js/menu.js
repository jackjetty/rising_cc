...
function InitLeftMenu() {
	var _menus = {};
		...
		$.ajax({
			type: "GET",
			url: "/rising-zptc-admin/perm/create_easyui_tree?date="+new Date(),
			dataType: "json",
			async: false,
        ...
        $.each(n.menus, function(j, o) {
			...
			if(o.child && o.child.length>0)
			{
				...
				$.each(o.child,function(k,p){
					menulist += '<li><div><a ref="'+p.menuid+'"  rel="' + p.url + '" ><span class="icon '+p.icon+'" >&nbsp;</span><span class="nav">' + p.menuname + '</span></a></div> </li>'
