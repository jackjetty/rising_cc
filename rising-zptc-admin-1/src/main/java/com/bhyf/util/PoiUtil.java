...
public class PoiUtil {
    ...
    public static void copySheet(XSSFSheet targetSheet, XSSFSheet sourceSheet,
        ...
        XSSFDrawing drawing = targetSheet.createDrawingPatriarch(); //用于复制注释
        for (int i = sourceSheet.getFirstRowNum(); i <= sourceSheet.getLastRowNum(); i++) {
            ...
            if (sourceRow != null) {
                copyRow(targetRow, sourceRow,
                        targetWork, sourceWork,drawing, styleMap);
    ...
    public static void copyRow(XSSFRow targetRow, XSSFRow sourceRow,
    		XSSFWorkbook targetWork, XSSFWorkbook sourceWork,XSSFDrawing targetPatriarch, Map styleMap) throws Exception {
