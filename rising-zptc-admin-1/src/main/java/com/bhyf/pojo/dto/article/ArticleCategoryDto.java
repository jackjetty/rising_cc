 ...
 */
public class ArticleCategoryDto extends BaseModel{
    ...
    public ArticleCategoryDto(ArticleCategory articleCategory) {
        setId(articleCategory.getId());
        this.name = articleCategory.getName();
        this.level = articleCategory.getLevel();
        this.parentId = articleCategory.getParentId();
        this.status = articleCategory.getStatus();
        this.hasChildren = articleCategory.getHasChildren();
        this.hasArticle = articleCategory.getHasArticle();
    ...
    public List<ArticleCategoryDto> getChildren() {
        return children;
    }

    public void setChildren(List<ArticleCategoryDto> children) {
