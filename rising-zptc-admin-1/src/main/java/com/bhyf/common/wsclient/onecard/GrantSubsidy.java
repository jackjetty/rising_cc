 ...
 *         &lt;element name="nMonSubsidy" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = { "sidNo", "nidType", "nStaNum", "nOptNum",
		"neWalletNum", "nMonSubsidy" })
@XmlRootElement(name = "GrantSubsidy")
public class GrantSubsidy {
	...
	/**
	 * Gets the value of the nMonSubsidy property.
	 * 
	 */
	public int getNMonSubsidy() {
		return nMonSubsidy;
	}

	/**
	 * Sets the value of the nMonSubsidy property.
	 * 
	 */
	public void setNMonSubsidy(int value) {
		this.nMonSubsidy = value;
	}
