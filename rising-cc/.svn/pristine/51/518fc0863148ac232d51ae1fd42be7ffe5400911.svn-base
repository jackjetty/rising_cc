package com.rising.cc.dao.user;
...
public interface SysUserDao {
	...
	/**
	 * 
	 * @description 根据用户ID，删除用户环境关系数据
	 * @author caoy
	 * @date 2015年8月25日 下午3:46:13
	 * @param roleId
	 * @return
	 */
	public Integer deleteOldUserEnvirByUserId(@Param("userId")Integer userId, @Param("list")List<Integer> envirList);
	...
	/**
	 * 
	 * @description 批量更新用户环境关系
	 * @author caoy
	 * @date 2015年8月25日 下午3:55:02
	 * @param list
	 * @return
	 */
	public Integer insertBatchUserEnvir(List<SysUserEnvir> list);
