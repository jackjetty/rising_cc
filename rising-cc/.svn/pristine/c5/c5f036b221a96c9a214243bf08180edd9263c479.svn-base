...
public class UpdateRabbitMqCommand implements Serializable{
	...
	public Integer getRabbitMqId() {
		return rabbitMqId;
	}

	public void setRabbitMqId(Integer rabbitMqId) {
	...
	public void createCommand(EditRabbitMqCommand command) {
		...
		this.rabbitMqId = Integer.valueOf(command.getId());
	}
