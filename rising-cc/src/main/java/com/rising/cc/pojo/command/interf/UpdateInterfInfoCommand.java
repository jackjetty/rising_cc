 ...
 * 修改备注：
 */
public class UpdateInterfInfoCommand extends BaseCommand{
    ...
    public void createCommand(EditInterfInfoCommand command) {
        ...
        setMethodId(command.getMethodId());
        setNode(command.getNode());
        setNodeName(command.getNodeName());
        setParentId(command.getParentId());
        setNodeType(command.getNodeType());
        setNodeLength(command.getNodeLength());
        setIsEmpty(command.getIsEmpty());
